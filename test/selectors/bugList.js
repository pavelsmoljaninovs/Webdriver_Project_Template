export default {
  FirstTableColumn: '//span[@class="hover-icon"]',
  SecondTableColumn: '#root > div > div.site-content > div > div.small-text > table > thead > tr > th:nth-child(2) > p',
  ThirdTableColumn: '#root > div > div.site-content > div > div.small-text > table > thead > tr > th:nth-child(3) > p',
  FourthTableColumn: '#root > div > div.site-content > div > div.small-text > table > thead > tr > th:nth-child(4) > p',
